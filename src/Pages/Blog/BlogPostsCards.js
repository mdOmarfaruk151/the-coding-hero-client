      ...
      <div className="mt-3 drop-shadow-lg ">
        <Card className="text-center  dark:bg-black border-2  rounded  dark:border-sky-500 border-gray-500">
          ...
          <Card.Body
            ...
            <span className="badge badge-lg badge-dark dark:badge-info hover:animate-bounce ">
              {topic}
            </span>
            <Card.Title>
              <h4 className="text-start">{question}</h4>
              <span className="badge badge-lg  badge-warning hover:animate-bounce text-black ">
                NEW
              </span>
            ...
            <Card.Text className="text-justify font-sans text-lg">
              {ans.length > 250 ? (
                <>
                  {ans.slice(0, 250) + "..."}
                  <Link className="no-underline text-lg" to={`/blogs/${id}`}>
                    Read More
                  </Link>
                </>
              ) : (
