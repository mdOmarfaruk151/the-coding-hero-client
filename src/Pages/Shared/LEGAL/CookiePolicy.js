...
const CookiePolicy = () => {
    return (
        <div className='container mb-5'>
            <h1 className='text-center mt-4 mb-3'>Cookie Policy for The Coding Hero</h1>

<p>This is the Cookie Policy for The Coding Hero, accessible from <Link>www.web.the.coding-hero.com</Link></p>
...
<ul>
<li>Email: <Link>the.coding.hero@gmail.com</Link></li>
